...
// Variable: PRODUCT_BYS_SLUG_QUERY
// Query: *[    _type == "product" && slug.current == $slug    ] | order(name asc)[0]
export type PRODUCT_BYS_SLUG_QUERYResult = {
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: CATEGORY_ID_QUERY
// Query: *[_type == "category" && slug.current == $categorySlug][0]._id
export type CATEGORY_ID_QUERYResult = string | null;
// Variable: PRODUCTS_BY_CATEGORY_QUERY
// Query: *[        _type == "product" && $categoryId in categories[]._ref      ] | order(name asc)
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[\n    _type == \"product\" && slug.current == $slug\n    ] | order(name asc)[0]": PRODUCT_BYS_SLUG_QUERYResult;
    "*[_type == \"category\" && slug.current == $categorySlug][0]._id": CATEGORY_ID_QUERYResult;
    "*[\n        _type == \"product\" && $categoryId in categories[]._ref\n      ] | order(name asc)": PRODUCTS_BY_CATEGORY_QUERYResult;
    "*[\n    _type == \"product\" &&\n    name match $searchParam\n    ] | order(name asc)": SEARCH_PRODUCT_QUERYResult;
